...
export const Footer = () => {
    return (
        <CDBNavbar className="shadow" style={{ backgroundColor: "rgb(200, 248, 165)", padding: '10%', margin: "0%", width: '100%' }}>
            <CDBBox display="flex" flex="column" style={{ width: '100%' }}>
                ...
                <CDBBox
                    ...
                    style={{ width: '100%' }}
                >
                    <CDBBox display="flex" alignItems="center" marginBotton='0'>
                        <a href="/" className="d-flex align-items-center p-0 text-dark">
                            <img
                                ...
                                width="30px"
                            />
                            <span className="ms-4 h5 mb-0 font-weight-bold">Gayatri Sambare</span>
                        </a>
                    </CDBBox>
                    <CDBBox>
